...
const Home = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#0a0a0a] text-white">
      ...
      <section className="relative z-10 min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-10 py-24 sm:py-28">
        <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
          ...
          <div className="text-center lg:text-left">
            <div className="inline-flex items-center gap-3 px-4 sm:px-6 py-2 sm:py-3 rounded-full border border-yellow-500/20 bg-yellow-500/10 backdrop-blur-xl mb-6 sm:mb-8">
              <div className="w-2 h-2 sm:w-2.5 sm:h-2.5 rounded-full bg-yellow-400 animate-pulse"></div>
              <span className="text-yellow-400 uppercase tracking-[0.2em] sm:tracking-[0.4em] text-[9px] sm:text-[11px] font-black">
                MILLIY TAOMLAR
              </span>
            </div>

            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-black leading-tight sm:leading-none tracking-tight uppercase">
              <span className="block text-white">Xush kelibsiz</span>
              <span className="block mt-2 sm:mt-3 text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 via-amber-400 to-orange-500 text-5xl sm:text-6xl md:text-7xl lg:text-8xl">
                QOZONDA
              </span>
              <span className="block text-white mt-2 sm:mt-3 text-2xl sm:text-3xl md:text-4xl lg:text-5xl normal-case tracking-normal text-gray-300">
                dasturxoniga
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-5 mt-6 sm:mt-10 justify-center lg:justify-start">
              <button 
                ...
                className="group relative overflow-hidden px-8 sm:px-12 py-4 sm:py-5 rounded-2xl bg-gradient-to-r from-yellow-400 via-amber-500 to-orange-500 text-black font-black text-xs sm:text-sm uppercase tracking-[0.2em] sm:tracking-[0.3em] transition-all duration-300 hover:scale-105 hover:shadow-[0_0_50px_rgba(255,215,0,0.5)] active:scale-95"
              >
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-5 mt-10 sm:mt-16">
              {[
                ...
                <div key={i} className="bg-white/[0.03] border border-white/5 backdrop-blur-xl rounded-xl sm:rounded-2xl p-3 sm:p-5 text-center hover:border-yellow-500/20 transition-all duration-300">
                  <h3 className="text-xl sm:text-2xl lg:text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-orange-500">
                    {item.val}
                  </h3>
          ...
          <div className="relative flex justify-center mt-8 lg:mt-0">
            ...
            <div className="relative w-full max-w-[400px] sm:max-w-[450px] md:max-w-[500px] rounded-[30px] sm:rounded-[40px] overflow-hidden border border-yellow-500/20 bg-white/[0.03] backdrop-blur-3xl shadow-[0_0_100px_rgba(255,215,0,0.06)] group">
              <img 
                loading="lazy"
              ...
              <div className="absolute bottom-4 sm:bottom-6 left-4 sm:left-6 right-4 sm:right-6 bg-black/50 border border-yellow-500/20 backdrop-blur-2xl rounded-2xl sm:rounded-3xl p-4 sm:p-6">
                <span className="text-yellow-400 uppercase tracking-[0.2em] sm:tracking-[0.4em] text-[8px] sm:text-[10px] font-black">
                  Signature Taom
                </span>
      ...
      {/* FEATURES SECTION */}
      <section className="relative z-10 py-16 sm:py-20 lg:py-28 border-t border-yellow-500/15">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-10">
          <div className="text-center mb-12 sm:mb-16 lg:mb-20">
            <span className="text-yellow-500 uppercase tracking-[0.3em] sm:tracking-[0.5em] text-[10px] sm:text-xs font-black">
              Nega QOZONDA
            </span>
            <h2 className="mt-3 sm:mt-5 text-3xl sm:text-4xl lg:text-5xl font-black uppercase leading-tight">
              Yangi massaliqlardan <br className="block sm:hidden" />
              <span className="text-yellow-500">Dasturxonga</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              <div 
                key={i} 
                className="group relative overflow-hidden rounded-[24px] sm:rounded-[32px] border border-white/5 bg-white/[0.03] backdrop-blur-3xl p-8 sm:p-10 lg:p-12 hover:border-yellow-500/30 hover:scale-[1.02] sm:hover:scale-[1.03] hover:shadow-[0_0_50px_rgba(255,215,0,0.05)] transition-all duration-500"
              >
                ...
                <div className="relative z-10">
                  <div className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-yellow-400 to-orange-500 flex items-center justify-center text-4xl sm:text-5xl shadow-[0_0_45px_rgba(255,215,0,0.3)]">
                    {item.icon}
                  </div>
                  <h3 className="text-xl sm:text-2xl font-black mt-6 sm:mt-8">{item.title}</h3>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mt-12 sm:mt-16 lg:mt-20">
            {[
              ...
              <div key={i} className="group relative h-40 sm:h-48 md:h-56 lg:h-64 rounded-2xl sm:rounded-3xl overflow-hidden border border-yellow-500/10">
                <img 
                  loading="lazy"
                  src={g.src} 
                  alt={g.label} 
