...
const PaymentModal = ({ isOpen, onClose, orderId, totalPrice, onSuccess }) => {
  ...
  const paymentMethods = [
    ...
    { id: 'cash', name: 'Naqd pul', icon: '💰', color: 'from-[#FFC93C] to-[#FF5A1F]' },
  ];
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
      ...
      <div className="relative bg-gradient-to-br from-gray-900 to-black border border-[#FFC93C]/20 rounded-[32px] p-8 sm:p-12 max-w-lg w-full shadow-[0_0_100px_rgba(255,180,40,0.08)] animate-fadeInUp">
        ...
        <div className="text-center mb-8">
          <div className="w-20 h-20 mx-auto rounded-2xl bg-gradient-to-r from-[#FFDD73] to-[#FF5A1F] flex items-center justify-center text-4xl shadow-[0_0_50px_rgba(255,180,40,0.3)]">
            💳
          </div>
          <h2 className="text-2xl font-black mt-4 text-white">To'lov</h2>
          <p className="text-gray-400 text-sm mt-2">
            Jami: <span className="text-[#FFDD73] font-bold text-lg">{totalPrice.toLocaleString()} so'm</span>
          </p>
        </div>
            ...
            <button
              ...
              className={`
                ...
                ${selectedMethod === method.id
                  ? `border-[#FFDD73] bg-[#FFC93C]/15 shadow-[0_0_35px_rgba(255,180,40,0.15)]`
                  : 'border-white/10 bg-white/[0.03] hover:border-[#FFC93C]/30'
                }
              `}
            >
              ...
              {selectedMethod === method.id && (
                <div className="absolute top-2 right-2 w-3.5 h-3.5 rounded-full bg-[#FFDD73] shadow-[0_0_10px_rgba(255,180,40,0.5)]"></div>
              )}
            </button>
          ))}
        </div>
        ...
        <button
          ...
          className="
            ...
            transition-all hover:scale-[1.02] hover:shadow-[0_0_50px_rgba(255,180,40,0.4)]
